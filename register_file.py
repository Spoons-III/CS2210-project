"""
Register file for the Catamount Processing Unit
...
class RegisterFile:
    """
    Two read ports, one write port register file, with the specified number
    of registers (8).
    """
